package nc.ui.hkjt.store.lvyun_out.ace.view;
...
public class Hk_store_lvyun_out_config extends AbstractJavaBeanDefinition {
	...
	public nc.ui.hkjt.store.lvyun_out.ace.serviceproxy.AceHk_store_lvyun_outMaintainProxy getBmModelModelService() {
		if (context.get("bmModelModelService") != null)
			return (nc.ui.hkjt.store.lvyun_out.ace.serviceproxy.AceHk_store_lvyun_outMaintainProxy) context
					.get("bmModelModelService");
		nc.ui.hkjt.store.lvyun_out.ace.serviceproxy.AceHk_store_lvyun_outMaintainProxy bean = new nc.ui.hkjt.store.lvyun_out.ace.serviceproxy.AceHk_store_lvyun_outMaintainProxy();
	...
	private List getManagedList1() {
		List list = new ArrayList();
		list.add(getBodyAddLineAction_1a49dcd());
		list.add(getBodyInsertLineAction_7404ba());
		list.add(getBodyDelLineAction_e26936());
		return list;
	}

	private nc.ui.pubapp.uif2app.actions.BodyAddLineAction getBodyAddLineAction_1a49dcd() {
		if (context
				.get("nc.ui.pubapp.uif2app.actions.BodyAddLineAction#1a49dcd") != null)
			return (nc.ui.pubapp.uif2app.actions.BodyAddLineAction) context
					.get("nc.ui.pubapp.uif2app.actions.BodyAddLineAction#1a49dcd");
		nc.ui.pubapp.uif2app.actions.BodyAddLineAction bean = new nc.ui.pubapp.uif2app.actions.BodyAddLineAction();
		context.put("nc.ui.pubapp.uif2app.actions.BodyAddLineAction#1a49dcd",
				bean);
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	private nc.ui.pubapp.uif2app.actions.BodyInsertLineAction getBodyInsertLineAction_7404ba() {
		if (context
				.get("nc.ui.pubapp.uif2app.actions.BodyInsertLineAction#7404ba") != null)
			return (nc.ui.pubapp.uif2app.actions.BodyInsertLineAction) context
					.get("nc.ui.pubapp.uif2app.actions.BodyInsertLineAction#7404ba");
		nc.ui.pubapp.uif2app.actions.BodyInsertLineAction bean = new nc.ui.pubapp.uif2app.actions.BodyInsertLineAction();
		context.put("nc.ui.pubapp.uif2app.actions.BodyInsertLineAction#7404ba",
				bean);
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	private nc.ui.pubapp.uif2app.actions.BodyDelLineAction getBodyDelLineAction_e26936() {
		if (context
				.get("nc.ui.pubapp.uif2app.actions.BodyDelLineAction#e26936") != null)
			return (nc.ui.pubapp.uif2app.actions.BodyDelLineAction) context
					.get("nc.ui.pubapp.uif2app.actions.BodyDelLineAction#e26936");
		nc.ui.pubapp.uif2app.actions.BodyDelLineAction bean = new nc.ui.pubapp.uif2app.actions.BodyDelLineAction();
		context.put("nc.ui.pubapp.uif2app.actions.BodyDelLineAction#e26936",
				bean);
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	public nc.ui.uif2.TangramContainer getContainer() {
		...
		bean.setTangramLayoutRoot(getTBNode_1e97539());
	...
	private nc.ui.uif2.tangramlayout.node.TBNode getTBNode_1e97539() {
		if (context.get("nc.ui.uif2.tangramlayout.node.TBNode#1e97539") != null)
			return (nc.ui.uif2.tangramlayout.node.TBNode) context
					.get("nc.ui.uif2.tangramlayout.node.TBNode#1e97539");
		nc.ui.uif2.tangramlayout.node.TBNode bean = new nc.ui.uif2.tangramlayout.node.TBNode();
		context.put("nc.ui.uif2.tangramlayout.node.TBNode#1e97539", bean);
	...
	private List getManagedList2() {
		List list = new ArrayList();
		list.add(getHSNode_1e76d82());
		list.add(getVSNode_84c9fe());
		return list;
	}

	private nc.ui.uif2.tangramlayout.node.HSNode getHSNode_1e76d82() {
		if (context.get("nc.ui.uif2.tangramlayout.node.HSNode#1e76d82") != null)
			return (nc.ui.uif2.tangramlayout.node.HSNode) context
					.get("nc.ui.uif2.tangramlayout.node.HSNode#1e76d82");
		nc.ui.uif2.tangramlayout.node.HSNode bean = new nc.ui.uif2.tangramlayout.node.HSNode();
		context.put("nc.ui.uif2.tangramlayout.node.HSNode#1e76d82", bean);
		bean.setLeft(getCNode_6988e4());
		bean.setRight(getCNode_9a6335());
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_6988e4() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#6988e4") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context
					.get("nc.ui.uif2.tangramlayout.node.CNode#6988e4");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#6988e4", bean);
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_9a6335() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#9a6335") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context
					.get("nc.ui.uif2.tangramlayout.node.CNode#9a6335");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#9a6335", bean);
	...
	private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_84c9fe() {
		if (context.get("nc.ui.uif2.tangramlayout.node.VSNode#84c9fe") != null)
			return (nc.ui.uif2.tangramlayout.node.VSNode) context
					.get("nc.ui.uif2.tangramlayout.node.VSNode#84c9fe");
		nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
		context.put("nc.ui.uif2.tangramlayout.node.VSNode#84c9fe", bean);
		bean.setUp(getCNode_c697b5());
		bean.setDown(getCNode_122a05());
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_c697b5() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#c697b5") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context
					.get("nc.ui.uif2.tangramlayout.node.CNode#c697b5");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#c697b5", bean);
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_122a05() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#122a05") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context
					.get("nc.ui.uif2.tangramlayout.node.CNode#122a05");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#122a05", bean);
	...
	public nc.ui.uif2.actions.ActionContributors getToftpanelActionContributors() {
		...
		bean.setContributors(getManagedList5());
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	}
	...
	public java.util.ArrayList getNormEditAction() {
		...
		java.util.ArrayList bean = new java.util.ArrayList(getManagedList8());
		context.put("normEditAction", bean);
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	}
	...
	public nc.ui.pubapp.uif2app.model.DefaultFuncNodeInitDataListener getInitDataListener() {
		...
		bean.setModel(getBmModel());
		bean.setContext(getContext());
		bean.setVoClassName("nc.vo.hkjt.store.lvyun.out.LyOutStoreBillVO");
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	}
	...
	private List getManagedList9() {
		List list = new ArrayList();
		list.add(getEventHandlerGroup_148d6af());
		list.add(getEventHandlerGroup_1edf45e());
		return list;
	}

	private nc.ui.pubapp.uif2app.event.EventHandlerGroup getEventHandlerGroup_148d6af() {
		if (context.get("nc.ui.pubapp.uif2app.event.EventHandlerGroup#148d6af") != null)
			return (nc.ui.pubapp.uif2app.event.EventHandlerGroup) context
					.get("nc.ui.pubapp.uif2app.event.EventHandlerGroup#148d6af");
		nc.ui.pubapp.uif2app.event.EventHandlerGroup bean = new nc.ui.pubapp.uif2app.event.EventHandlerGroup();
		context.put("nc.ui.pubapp.uif2app.event.EventHandlerGroup#148d6af",
				bean);
		bean.setEvent("nc.ui.pubapp.uif2app.event.OrgChangedEvent");
		bean.setHandler(getAceOrgChangeHandler_f30bd());
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	}

	private nc.ui.hkjt.store.lvyun_out.ace.handler.AceOrgChangeHandler getAceOrgChangeHandler_f30bd() {
		if (context
				.get("nc.ui.hkjt.store.lvyun_out.ace.handler.AceOrgChangeHandler#f30bd") != null)
			return (nc.ui.hkjt.store.lvyun_out.ace.handler.AceOrgChangeHandler) context
					.get("nc.ui.hkjt.store.lvyun_out.ace.handler.AceOrgChangeHandler#f30bd");
		nc.ui.hkjt.store.lvyun_out.ace.handler.AceOrgChangeHandler bean = new nc.ui.hkjt.store.lvyun_out.ace.handler.AceOrgChangeHandler();
		context.put(
				"nc.ui.hkjt.store.lvyun_out.ace.handler.AceOrgChangeHandler#f30bd",
				bean);
	...
	private nc.ui.pubapp.uif2app.event.EventHandlerGroup getEventHandlerGroup_1edf45e() {
		if (context.get("nc.ui.pubapp.uif2app.event.EventHandlerGroup#1edf45e") != null)
			return (nc.ui.pubapp.uif2app.event.EventHandlerGroup) context
					.get("nc.ui.pubapp.uif2app.event.EventHandlerGroup#1edf45e");
		nc.ui.pubapp.uif2app.event.EventHandlerGroup bean = new nc.ui.pubapp.uif2app.event.EventHandlerGroup();
		context.put("nc.ui.pubapp.uif2app.event.EventHandlerGroup#1edf45e",
				bean);
		bean.setEvent("nc.ui.pubapp.uif2app.event.billform.AddEvent");
		bean.setHandler(getAceAddHandler_1069055());
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	}

	private nc.ui.hkjt.store.lvyun_out.ace.handler.AceAddHandler getAceAddHandler_1069055() {
		if (context
				.get("nc.ui.hkjt.store.lvyun_out.ace.handler.AceAddHandler#1069055") != null)
			return (nc.ui.hkjt.store.lvyun_out.ace.handler.AceAddHandler) context
					.get("nc.ui.hkjt.store.lvyun_out.ace.handler.AceAddHandler#1069055");
		nc.ui.hkjt.store.lvyun_out.ace.handler.AceAddHandler bean = new nc.ui.hkjt.store.lvyun_out.ace.handler.AceAddHandler();
		context.put(
				"nc.ui.hkjt.store.lvyun_out.ace.handler.AceAddHandler#1069055",
				bean);
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	private List getManagedList10() {
		List list = new ArrayList();
		list.add(getCardPanelLazilyLoad_1466d3d());
		list.add(getListPanelLazilyLoad_add2e9());
		return list;
	}

	private nc.ui.pubapp.uif2app.lazilyload.CardPanelLazilyLoad getCardPanelLazilyLoad_1466d3d() {
		if (context
				.get("nc.ui.pubapp.uif2app.lazilyload.CardPanelLazilyLoad#1466d3d") != null)
			return (nc.ui.pubapp.uif2app.lazilyload.CardPanelLazilyLoad) context
					.get("nc.ui.pubapp.uif2app.lazilyload.CardPanelLazilyLoad#1466d3d");
		nc.ui.pubapp.uif2app.lazilyload.CardPanelLazilyLoad bean = new nc.ui.pubapp.uif2app.lazilyload.CardPanelLazilyLoad();
		context.put(
				"nc.ui.pubapp.uif2app.lazilyload.CardPanelLazilyLoad#1466d3d",
				bean);
		bean.setBillform(getBillForm());
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
	...
	private nc.ui.pubapp.uif2app.lazilyload.ListPanelLazilyLoad getListPanelLazilyLoad_add2e9() {
		if (context
				.get("nc.ui.pubapp.uif2app.lazilyload.ListPanelLazilyLoad#add2e9") != null)
			return (nc.ui.pubapp.uif2app.lazilyload.ListPanelLazilyLoad) context
					.get("nc.ui.pubapp.uif2app.lazilyload.ListPanelLazilyLoad#add2e9");
		nc.ui.pubapp.uif2app.lazilyload.ListPanelLazilyLoad bean = new nc.ui.pubapp.uif2app.lazilyload.ListPanelLazilyLoad();
		context.put(
				"nc.ui.pubapp.uif2app.lazilyload.ListPanelLazilyLoad#add2e9",
				bean);
	...
	public nc.ui.pubapp.uif2app.actions.RefreshSingleAction getRefreshCardAction() {
	...
	public nc.ui.pubapp.uif2app.actions.AddAction getAddAction() {
		...
		bean.setModel(getBmModel());
		bean.setInterceptor(getCompositeActionInterceptor_dce3a8());
	...
	private nc.ui.pubapp.uif2app.actions.interceptor.CompositeActionInterceptor getCompositeActionInterceptor_dce3a8() {
		if (context
				.get("nc.ui.pubapp.uif2app.actions.interceptor.CompositeActionInterceptor#dce3a8") != null)
			return (nc.ui.pubapp.uif2app.actions.interceptor.CompositeActionInterceptor) context
					.get("nc.ui.pubapp.uif2app.actions.interceptor.CompositeActionInterceptor#dce3a8");
		...
		context.put(
				"nc.ui.pubapp.uif2app.actions.interceptor.CompositeActionInterceptor#dce3a8",
				bean);
	...
	private List getManagedList11() {
		List list = new ArrayList();
		list.add(getShowUpComponentInterceptor_1f1d8fd());
		return list;
	}

	private nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor getShowUpComponentInterceptor_1f1d8fd() {
		if (context
				.get("nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor#1f1d8fd") != null)
			return (nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor) context
					.get("nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor#1f1d8fd");
		nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor bean = new nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor();
		context.put(
				"nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor#1f1d8fd",
				bean);
		bean.setShowUpComponent(getBillForm());
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
	...
	public nc.ui.pubapp.uif2app.actions.pflow.CommitScriptAction getCommitScriptAction() {
		 ...
		 * HK≤‚ ‘
		 */
//		bean.setInterceptor(new nc.ui.hkjt.store.lvyun_out.ace.action.interceptor.RefreshInterceptor());
		/***END***/
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
