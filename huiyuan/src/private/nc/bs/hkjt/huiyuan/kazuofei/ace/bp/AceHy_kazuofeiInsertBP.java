 ...
 * 标准单据新增BP
 */
public class AceHy_kazuofeiInsertBP {

	public KazuofeiBillVO[] insert(KazuofeiBillVO[] bills) {

		InsertBPTemplate<KazuofeiBillVO> bp = new InsertBPTemplate<KazuofeiBillVO>(
				Hy_kazuofeiPluginPoint.INSERT);
	 ...
	 * @param processor
	 */
	private void addAfterRule(AroundProcesser<KazuofeiBillVO> processor) {
		// TODO 新增后规则
	...
	private void addBeforeRule(AroundProcesser<KazuofeiBillVO> processer) {
		...
		((nc.bs.pubapp.pub.rule.CreateBillCodeRule) rule).setCbilltype("HK28");
