 ...
 * 标准单据新增BP
 */
public class AceHy_cikatongjiInsertBP {

	public CikatongjiBillVO[] insert(CikatongjiBillVO[] bills) {

		InsertBPTemplate<CikatongjiBillVO> bp = new InsertBPTemplate<CikatongjiBillVO>(
				Hy_cikatongjiPluginPoint.INSERT);
	 ...
	 * @param processor
	 */
	private void addAfterRule(AroundProcesser<CikatongjiBillVO> processor) {
		// TODO 新增后规则
	...
	private void addBeforeRule(AroundProcesser<CikatongjiBillVO> processer) {
		...
		((nc.bs.pubapp.pub.rule.CreateBillCodeRule) rule).setCbilltype("HK31");
