 ...
 * 标准单据新增BP
 */
public class AceHy_cikayueInsertBP {

	public CikayueBillVO[] insert(CikayueBillVO[] bills) {

		InsertBPTemplate<CikayueBillVO> bp = new InsertBPTemplate<CikayueBillVO>(
				Hy_cikayuePluginPoint.INSERT);
	 ...
	 * @param processor
	 */
	private void addAfterRule(AroundProcesser<CikayueBillVO> processor) {
		// TODO 新增后规则
	...
	private void addBeforeRule(AroundProcesser<CikayueBillVO> processer) {
		...
		((nc.bs.pubapp.pub.rule.CreateBillCodeRule) rule).setCbilltype("HK30");
