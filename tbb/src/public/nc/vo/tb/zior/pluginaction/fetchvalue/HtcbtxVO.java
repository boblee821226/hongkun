 ...
 * 合同成本摊销
 */
public class HtcbtxVO extends SuperVO {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1044262014288195875L;
	
	private String pk_srxm;		// 收入项目
	private String vbillcode;	// 合同号
	private String cvendorid;	// 供应商
	private String fplx;		// 发票类型
	private UFDouble sl;		// 税率
	private String price;		// 平均单价
	private UFDouble mianji;	// 面积
	private String begin_date;	// 开始日期yyyy-mm-dd
	private String end_date;	// 截至日期yyyy-mm-dd
	private String srxm_name;	// 收入项目name
