 ...
 * 标准单据新增BP
 */
public class AceJd_rzmxInsertBP {

	public RzmxBillVO[] insert(RzmxBillVO[] bills) {

		InsertBPTemplate<RzmxBillVO> bp = new InsertBPTemplate<RzmxBillVO>(
				Jd_rzmxPluginPoint.INSERT);
	 ...
	 * @param processor
	 */
	private void addAfterRule(AroundProcesser<RzmxBillVO> processor) {
		// TODO 新增后规则
	...
	private void addBeforeRule(AroundProcesser<RzmxBillVO> processer) {
		...
		((nc.bs.pubapp.pub.rule.CreateBillCodeRule) rule).setCbilltype("HK11");
