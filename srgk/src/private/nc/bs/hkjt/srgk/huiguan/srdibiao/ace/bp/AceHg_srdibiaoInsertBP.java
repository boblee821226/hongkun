 ...
 * 标准单据新增BP
 */
public class AceHg_srdibiaoInsertBP {

	public SrdibiaoBillVO[] insert(SrdibiaoBillVO[] bills) {

		InsertBPTemplate<SrdibiaoBillVO> bp = new InsertBPTemplate<SrdibiaoBillVO>(
				Hg_srdibiaoPluginPoint.INSERT);
	 ...
	 * @param processor
	 */
	private void addAfterRule(AroundProcesser<SrdibiaoBillVO> processor) {
		// TODO 新增后规则
	...
	private void addBeforeRule(AroundProcesser<SrdibiaoBillVO> processer) {
		...
		((nc.bs.pubapp.pub.rule.CreateBillCodeRule) rule).setCbilltype("HK03");
